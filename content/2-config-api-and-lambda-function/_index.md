...
2. Add the following code to **template.yaml** file to config 3 lambda functions:  **upload_docs**, **list_docs** and **delete_doc**
```yaml
...
7. Similarly, create **upload_docs/upload_docs.py** folder and file in **lambda** folder. Next copy the code below for the created file.
```python
import json
import boto3
import os
